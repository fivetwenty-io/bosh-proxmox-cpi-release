#!/usr/bin/env bun
// Compile docs/intro-overview/*.md into a single clean, readable index.html.
//
// - index.md leads, then chapters 01..10 in order.
...
// Run via `make docs-intro-overview-html` (bun only, never npm/npx).
