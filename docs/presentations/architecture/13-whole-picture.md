...
- Coverage is the plan: all 21 canonical CPI v2 methods with real logic plus the update_disk extension, and one of only two CPIs (with vSphere) to implement network lifecycle. Every remaining item is depth within a method, not a new stub.
