...
*The first principle of this chapter: the CPI is an impedance-matching transformer between an elastic orchestrator and an inelastic hypervisor; its core resilience job is to absorb a burst the server cannot.*
